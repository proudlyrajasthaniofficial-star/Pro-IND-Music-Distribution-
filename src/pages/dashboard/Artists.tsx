...
export default function Artists() {
  ...
  const handleImageUpload = async (e: React.ChangeEvent<HTMLInputElement>) => {
    ...
    try {
      ...
      toast.success("Image transmitted successfully.");
    } catch (err: any) {
      toast.error("Image upload failure: " + (err.message || "Unknown error"));
    } finally {
      setUploading(false);
    }
  };
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      if (editingArtist) {
        ...
        toast.success("Artist manifest updated.");
      } else {
        ...
        toast.success("New artist identity registered.");
      }
      setShowModal(false);
