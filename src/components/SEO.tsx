...
const SEO: React.FC<SEOProps> = ({
  ...
  const currentUrl = url || (typeof window !== 'undefined' ? window.location.href : 'https://musicdistributionindia.online');
  ...
  const defaultSchema = {
    ...
    "sameAs": [
      "https://facebook.com/inddistribution",
      "https://twitter.com/inddistribution",
      "https://instagram.com/inddistribution"
    ]
  };
